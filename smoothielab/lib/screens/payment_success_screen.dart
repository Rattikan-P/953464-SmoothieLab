...
class _PaymentSuccessScreenState extends State<PaymentSuccessScreen>
  ...
  final _steps = const [
    (icon: '📋', label: 'Order\nReceived',  sublabel: 'Your order has been received'),
    (icon: '🧪', label: 'Blending\nNow',    sublabel: 'Preparing your smoothie...'),
    (icon: '✅', label: 'Ready\nfor Pickup', sublabel: 'Come pick up at the counter!'),
  ];
                        ...
                        children: [
                          Text('PICKUP DETAILS',
                              style: TextStyle(
                                  ...
                                  letterSpacing: 1)),
                          SizedBox(height: 2),
                          Text('SmoothieLab — Siam Branch',
                              style: TextStyle(fontWeight: FontWeight.bold)),
                          Text('Est. time: 10-15 minutes',
                              style: TextStyle(
